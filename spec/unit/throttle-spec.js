...
describe('Throttle function', function() {
    ...
    it('should run a function only once in a given time period',
       inject(function(throttle) {
           var count = 0,
    ...
    it('should run a function only once in a given time period, and ignore ' +
       'the first call', inject(function(throttle, $timeout) {
        var count = 0,
            fn = throttle(function() {
                count += 1;
            }, 10, {leading: false});
...
describe('Debounce function', function() {
    ...
    it('should run a function only once _after_ a period of inactivity ',
       inject(function(debounce, $timeout, throttleNow) {
           var count = 0,
    ...
    it('should internally reset itself to ensure that it is only called once ' +
       'at the end ', inject(function(debounce, $timeout, throttleNow) {
